...
### App Description
An animated and styled Flashcard App that allows the user to create their own set of personalized flashcards.

### App Walk-though

<img src="http://g.recordit.co/c8G8OEngIt.gif" width=200><br>
